...
namespace mmbm.Migrations
{
    ...
    [Migration("20191213115617_AddConsolidatedReportToKiosk")]
    partial class AddConsolidatedReportToKiosk
    {
            ...
            modelBuilder.Entity("mmbm.Core.Models.ConsolidatedReport", b =>
                {
                    ...
                    b.Property<int>("MoblileMoneyReportId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MoblileMoneyReportId")
                        .IsUnique();
            ...
            modelBuilder.Entity("mmbm.Core.Models.ConsolidatedReport", b =>
                {
                    ...
                    b.HasOne("mmbm.Core.Models.MobileMoneyReport", "MobileMoneyReport")
                        .WithOne("ConsolidatedReport")
                        .HasForeignKey("mmbm.Core.Models.ConsolidatedReport", "MoblileMoneyReportId")
